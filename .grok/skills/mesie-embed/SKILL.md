...
name: mesie-embed
description: >
  Vectorize a spectral record with SpectralVectorizer. Triggers: embed, embedding, vectorize. Use for /mesie-embed or MESIE/MAESI/NeuroAIX tasks.
---
...
- Command: `python examples/06_create_spectral_embedding.py`
