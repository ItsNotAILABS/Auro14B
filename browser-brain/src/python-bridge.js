export class PythonEngineBridge{
  ...
  async triad(message,{context='',fluidize=false}={}){return this.request('/v1/triad/respond',{message,context,fluidize})}
