...
Focused tests verify artifact discovery, deterministic hashing, session and receipt metadata, search, replay, timeline conversion, continuation-context creation, and fail-closed behavior for unknown IDs.
