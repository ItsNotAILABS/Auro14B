export const MCP_TOOLS = [
  {
    name: "relay_read",
    description: "Read a public URL and return normalized, provenance-bearing content.",
    inputSchema: {
      type: "object",
      required: ["url"],
      properties: {
        url: { type: "string", format: "uri" },
        mode: { type: "string", enum: ["auto", "html", "feed", "json"], default: "auto" },
...
export async function handleMcp(request, readFn) {
  ...
  if (method === "initialize") {
    return mcpResponse(id, {
      ...
      serverInfo: { name: "nexus-relay", version: "0.1.0" }
    });
  }
